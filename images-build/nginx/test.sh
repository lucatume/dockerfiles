...
dgoss run --link test_support_php:php -v $(pwd)/tests/app:/var/www/html -e VIRTUAL_HOST=foo.bar -p 8080:80 lucatume/nginx-for-wp 
dgoss run --link test_support_php:php -v $(pwd)/tests/app:/var/www/html -e VIRTUAL_HOST=localhost:8080 -p 8080:80 lucatume/nginx-for-wp 
